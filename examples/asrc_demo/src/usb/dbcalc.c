 ...
 */
#define COEF_PREC 28
static uint32_t coef[14] = {2407, 13778, 64588, 308051, 1346110, 5261991, 18277531, 55564576, 144789513, 314406484, 546179875, 711608713, 618095479, 268435456};
...
uint32_t db_to_mult(int32_t db, int32_t db_frac_bits, int32_t result_frac_bits)
{
  ...
  int32_t val0=0;
  uint32_t ret;
  uint32_t mask = ~((1<<DB_CALC_PREC)-1);
